...
- **スクリプト**: [`../../scripts/r3-venue/v6-health-monitor.sh`](../../scripts/r3-venue/v6-health-monitor.sh)
...
詳細は [`home-vyos.md`](home-vyos.md) および [`../../scripts/r3-venue/wg-r1-tracker.sh`](../../scripts/r3-venue/wg-r1-tracker.sh)。
